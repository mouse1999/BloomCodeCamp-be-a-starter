...
public class AssignmentController {
    ...
    public ResponseEntity<?> createAssignment(
            @Valid @RequestBody CreateAssignmentRequest request, @AuthenticationPrincipal User currentUser) {
    ...
    public ResponseEntity<?> submitAssignment(@Valid @RequestBody SubmitAssignmentRequestDto requestDto,
        ...
        AssignmentModel assignmentModel = assignmentService.submitAssignment(assignmentId,
                                                                    requestDto.branch(),
    ...
    public ResponseEntity<?> claimSpecificAssignmentByReviewer(@PathVariable Long id,@AuthenticationPrincipal User reviewer ) {
        AssignmentModel assignmentModel = assignmentClaimingService.claimSpecificAssignment(id, reviewer)
                .orElse(null);
